...
var (
	...
	rawReaderDataCacheSize = env.Get("PRECISE_CODE_INTEL_READER_DATA_CACHE_CAPACITY", "1000000", "Maximum capacity of the sqlite data cache.") // TODO - need a better value here
